...
struct ReadingView: View {
    ...
    var body: some View {
        VStack {
            TimerView(goal: $readGoal, showingAlert: $showingAlert, elapsed: $elapsed, color: restColor, isTimed: isTimed, notificationTitle: "Reading Done", notificationSubtitle: "You completed your reading goal.")
        }
