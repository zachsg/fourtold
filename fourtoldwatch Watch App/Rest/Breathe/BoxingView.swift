...
#Preview {
    BoxingView(rounds: .constant(20), elapsed: .constant(0), mood: .constant(.neutral), endMood: .constant(.neutral), date: .constant(.now), type: .constant(.box), path: .constant(NavigationPath()))
}
